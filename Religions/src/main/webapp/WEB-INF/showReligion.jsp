...
th, td {
	width: auto;
			...
			<table>
				<tbody>
					<tr>
						...
						<td><strong>Date Established:</strong>
							${religion.dateEstablished}</td>
						<td><strong>Religion Founder:</strong> ${religion.founder}</td>
						<td><strong>Idol(s) of worship:</strong>
							${religion.idolOfWorship}</td>
						<td><strong>Number of followers:</strong>
							${religion.numOfFollowers}</td>
					</tr>
				</tbody>
			</table>
		...
		<c:otherwise>
			<p>No Religion details available. Please check to see if Religion
				ID is correct and try again.</p>
		</c:otherwise>
	</c:choose>
	<br>
	<br>
